...
// Convert between llms::Role and types::StandardRole
impl From<llms::Role> for types::StandardRole {
  fn from(role: llms::Role) -> Self {
    match role {
      llms::Role::User => types::StandardRole::User,
      llms::Role::Assistant => types::StandardRole::Assistant,
      llms::Role::System => types::StandardRole::System,
      llms::Role::Tool => types::StandardRole::Tool,
    }
  }
}

impl From<types::StandardRole> for llms::Role {
  fn from(role: types::StandardRole) -> Self {
    match role {
      types::StandardRole::User => llms::Role::User,
      types::StandardRole::Assistant => llms::Role::Assistant,
      types::StandardRole::System => llms::Role::System,
      types::StandardRole::Tool => llms::Role::Tool,
    }
  }
}
